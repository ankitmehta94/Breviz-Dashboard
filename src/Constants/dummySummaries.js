const Summaries = {
  ...
  'Man From Earth':{
    ...
    transcript:`HARRY
    Alright Spock, I'll play your little game. What do you want? What's the punch line?
    JOHN
    Every ten years or so, when people start to notice I don't age, I move on.
    Pause.
    ART
    ...That's very good, that's very quick John. I wanna read that story when you're done.
    JOHN
    You want more?
    HARRY
    Yeah, by all means. This is great! Alright,
    now... (chuckles) ...So you think you're a- auh- Cro-Magnon.
    JOHN
    Well, I didn't learn it in school. That's my best guess. Based on archaeological data, maps, anthropological research. Since Mesopotamia, I've got the last...four thousand years
    straight.
    ART
    Well you're ahead of most people, so please, go on.
    JOHN
    Well you know the background stuff, so I'll make it brief. In what I call my first lifetime, I aged to about thirty-five. What you see. I ended up leading my group. They saw me as magical. I didn't even have to fight for it.
    Then, fear came. And they chased me away. They thought that I was...stealing their lives away to stay young.
    HARRY
